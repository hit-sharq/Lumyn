...
export default function NewsManager() {
  ...
  if (loading) {
    return <LoadingState variant="compact" label="news" />;
  }
  return <>
      ...
      <div className={styles.manager}>
        ...
        {isEditing ? <form onSubmit={handleSubmit} className={styles.form}>
            ...
            {items.length === 0 ? <p className={styles.empty}>No news items yet. Click &quot;Add News&quot; to create one.</p> : items.map(item => <div key={item.id} className={styles.card}>
