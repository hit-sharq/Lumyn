  ...
  return <div className={styles.manager}>
      ...
      {isEditing ? <form onSubmit={handleSubmit} className={styles.form}>
          ...
          <div className={styles.formGroup}>
            ...
            <input type="file" accept="image/*" onChange={handleFileChange} required className={styles.input} />
        ...
        </form> : <div className={styles.gridList}>
          {items.length === 0 ? <p className={styles.empty}>No gallery items yet. Click &quot;Add Image&quot; to create one.</p> : items.map(item => <div key={item.id} className={styles.gridCard}>
