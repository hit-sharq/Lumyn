...
export default function HirePage() {
  ...
  return <div className={styles.page}>
      ...
      {view === "board" && <div className={styles.boardSection}>
          <div className={styles.container}>
            <div className={styles.filters}>
              {CATEGORIES.map(cat => <button key={cat} className={`${styles.filterBtn} ${selectedCategory === cat ? styles.activeFilter : ""}`} onClick={() => setSelectedCategory(cat)}>
                  {cat}
                </button>)}
            </div>
      ...
      {selectedJob && <div className={styles.modal} onClick={() => setSelectedJob(null)}>
          <div className={styles.modalContent} onClick={e => e.stopPropagation()}>
            ...
            <div className={styles.jobTags} style={{
          marginBottom: 24
        }}>
            ...
            <div className={styles.applySection}>
              {selectedJob.applicationUrl && <a href={selectedJob.applicationUrl} target="_blank" rel="noopener noreferrer" className={styles.applyBtnLarge}>Apply Now</a>}
              {selectedJob.applicationEmail && !selectedJob.applicationUrl && <a href={`mailto:${selectedJob.applicationEmail}`} className={styles.applyBtnLarge}>Apply via Email</a>}
              {selectedJob.companyWebsite && <a href={selectedJob.companyWebsite} target="_blank" rel="noopener noreferrer" className={styles.websiteBtn}>Company Website</a>}
            </div>
          </div>
        </div>}
          ...
          <div className={styles.container}>
            ...
            plan: plan.id
                  ...
                  <ul className={styles.planFeatures}>
                    {plan.features.map((f, i) => <li key={i} className={styles.planFeature}>✓ {f}</li>)}
                  </ul>
                </div>)}
            </div>
            ...
            <form className={styles.jobForm} onSubmit={handleSubmit}>
              ...
              <div className={styles.formRow}>
                <div className={styles.formGroup}>
                  ...
                  <input className={styles.input} required value={form.companyName} onChange={e => setForm(f => ({
                ...f,
                ...
                <div className={styles.formGroup}>
                  ...
                  <input className={styles.input} value={form.companyWebsite} onChange={e => setForm(f => ({
                ...f,
              ...
              <div className={styles.formGroup}>
                ...
                <input className={styles.input} value={form.companyLogo} onChange={e => setForm(f => ({
              ...f,
              ...
              <div className={styles.formRow}>
                <div className={styles.formGroup}>
                  ...
                  <input className={styles.input} required value={form.jobTitle} onChange={e => setForm(f => ({
                ...f,
                ...
                <div className={styles.formGroup}>
                  ...
                  <select className={styles.select} value={form.category} onChange={e => setForm(f => ({
                ...f,
              ...
              <div className={styles.formRow}>
                <div className={styles.formGroup}>
                  ...
                  <input className={styles.input} value={form.location} onChange={e => setForm(f => ({
                ...f,
                ...
                <div className={styles.formGroup}>
                  ...
                  <select className={styles.select} value={form.jobType} onChange={e => setForm(f => ({
                ...f,
              ...
              <div className={styles.formGroup}>
                ...
                <input className={styles.input} value={form.salary} onChange={e => setForm(f => ({
              ...f,
              salary: e.target.value
            }))} placeholder="KES 80,000 – 150,000 / month" />
              </div>
              <div className={styles.formGroup}>
                <label className={styles.label}>Job Description *</label>
                <textarea className={styles.textarea} required rows={8} value={form.jobDescription} onChange={e => setForm(f => ({
              ...f,
              jobDescription: e.target.value
            }))} placeholder="Describe the role, responsibilities, qualifications, and what makes this position great..." />
              </div>
              <div className={styles.formGroup}>
                <label className={styles.label}>Tags (comma-separated)</label>
                <input className={styles.input} value={form.tags} onChange={e => setForm(f => ({
              ...f,
              tags: e.target.value
              ...
              <div className={styles.formRow}>
                <div className={styles.formGroup}>
                  ...
                  <input className={styles.input} value={form.applicationUrl} onChange={e => setForm(f => ({
                ...f,
                ...
                <div className={styles.formGroup}>
                  ...
                  <input className={styles.input} type="email" value={form.applicationEmail} onChange={e => setForm(f => ({
                ...f,
              ...
              {!isSignedIn && <p className={styles.signInNote}>You need to <Link href="/sign-in">sign in</Link> before posting a job.</p>}
            </form>
          </div>
        </div>}
    </div>;
