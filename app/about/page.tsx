  ...
  const sections: Section[] = [
    ...
    },
    {
      ...
      content: (
        ...
        >
          {[
            { icon: "💻", title: "Web Design & Development", desc: "Creating beautiful, responsive websites that engage users and drive results" },
            { icon: "🎯", title: "Branding & Strategy", desc: "Developing comprehensive digital strategies that align with your brand vision" },
            { icon: "⚙️", title: "Full-Stack Apps", desc: "Building robust, scalable applications with modern technologies" },
            { icon: "☁️", title: "Cloud & Hosting", desc: "Seamless cloud solutions for reliable, secure, and scalable hosting" },
            { icon: "🛡️", title: "Security & Maintenance", desc: "Ongoing support, updates, and security monitoring" },
          ].map((service, i) => (
            <motion.div
              key={i}
    ...
    },
    {
      ...
      content: (
        <div className={styles.featureList}>
          {[
            { icon: "✨", title: "Modern Design", desc: "Clean design principles that prioritize user experience and visual appeal" },
            { icon: "📈", title: "Scalable Tech", desc: "Modern technologies that grow with your business needs" },
            { icon: "🔐", title: "Security First", desc: "Best practices for security and data protection" },
            { icon: "🤝", title: "Client-First", desc: "Transparent communication and collaboration throughout every project" },
            { icon: "✅", title: "Proven Results", desc: "Successfully launched numerous projects with measurable results" },
          ].map((feature, i) => (
            <motion.div
              key={i}
          ...
          <div className={styles.container}>
            {sections.map((section, index) => (
              <section
                ...
                className={`${styles.sectionWrapper} ${visibleSections.has(section.id) ? styles.visible : ""}`}
                style={{
