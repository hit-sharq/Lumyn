          ...
          <div className={styles.container}>
            <div className={styles.progressContent}>
              ...
              <div className={styles.progressSteps}>
                {steps.map(step => <div key={step.number} className={`${styles.progressStep} ${currentStep === step.number ? styles.activeStep : ""} ${currentStep > step.number ? styles.completedStep : ""}`}>
        ...
        <div className={styles.formContent}>
          <div className={styles.container}>
            <form onSubmit={handleSubmit} className={styles.applicationForm}>
              ...
              {currentStep === 1 && <div className={styles.formStep}>
                  ...
                  <div className={styles.formGrid}>
                    <div className={styles.formGroup}>
                      ...
                      <input type="text" id="firstName" name="firstName" value={formData.firstName} onChange={handleInputChange} className={`${styles.formInput} ${errors.firstName ? styles.errorInput : ""}`} placeholder="Enter your first name" />
                    ...
                    <div className={styles.formGroup}>
                      ...
                      <input type="text" id="lastName" name="lastName" value={formData.lastName} onChange={handleInputChange} className={`${styles.formInput} ${errors.lastName ? styles.errorInput : ""}`} placeholder="Enter your last name" />
                    ...
                    <div className={styles.formGroup}>
                      ...
                      <input type="email" id="email" name="email" value={formData.email} onChange={handleInputChange} className={`${styles.formInput} ${errors.email ? styles.errorInput : ""}`} placeholder="your.email@example.com" />
                    ...
                    <div className={styles.formGroup}>
                      ...
                      <input type="tel" id="phone" name="phone" value={formData.phone} onChange={handleInputChange} className={`${styles.formInput} ${errors.phone ? styles.errorInput : ""}`} placeholder="+1 (555) 123-4567" />
                    ...
                    <div className={styles.formGroup}>
                      ...
                      <input type="url" id="linkedIn" name="linkedIn" value={formData.linkedIn} onChange={handleInputChange} className={styles.formInput} placeholder="https://linkedin.com/in/yourprofile" />
                    </div>
                    ...
                    <div className={styles.formGroup}>
                      ...
                      <input type="url" id="portfolio" name="portfolio" value={formData.portfolio} onChange={handleInputChange} className={styles.formInput} placeholder="https://yourportfolio.com" />
                    </div>
                  </div>
                </div>}

              {/* Step 2: Professional Background */}
              {currentStep === 2 && <div className={styles.formStep}>
                  ...
                  <div className={styles.formGroup}>
                    ...
                    <textarea id="coverLetter" name="coverLetter" value={formData.coverLetter} onChange={handleInputChange} rows={6} className={`${styles.formTextarea} ${errors.coverLetter ? styles.errorInput : ""}`} placeholder="Tell us why you're interested in this position and what makes you a great fit..." />
                  ...
                  <div className={styles.formGroup}>
                    ...
                    <textarea id="experience" name="experience" value={formData.experience} onChange={handleInputChange} rows={4} className={`${styles.formTextarea} ${errors.experience ? styles.errorInput : ""}`} placeholder="Describe your relevant work experience, projects, or achievements..." />
                  ...
                  <div className={styles.formGrid}>
                    <div className={styles.formGroup}>
                      ...
                      <select id="availability" name="availability" value={formData.availability} onChange={handleInputChange} className={`${styles.formSelect} ${errors.availability ? styles.errorInput : ""}`}>
                    ...
                    <div className={styles.formGroup}>
                      ...
                      <input type="text" id="salaryExpectation" name="salaryExpectation" value={formData.salaryExpectation} onChange={handleInputChange} className={styles.formInput} placeholder="e.g., $60,000 - $80,000" />
                    </div>
                  </div>
                  ...
                  <div className={styles.formGroup}>
                    ...
                    <input type="url" id="resumeUrl" name="resumeUrl" value={formData.resumeUrl} onChange={handleInputChange} className={styles.formInput} placeholder="Link to your resume (Google Drive, Dropbox, etc.)" />
                  </div>
                  ...
                  <div className={styles.formGroup}>
                    ...
                    <textarea id="additionalInfo" name="additionalInfo" value={formData.additionalInfo} onChange={handleInputChange} rows={3} className={styles.formTextarea} placeholder="Any additional information you'd like to share..." />
                  </div>
                </div>}

              {/* Step 3: Review & Submit */}
              {currentStep === 3 && <div className={styles.formStep}>
                  ...
                  <div className={styles.reviewSection}>
                    ...
                    <div className={styles.reviewCard}>
                      ...
                      <div className={styles.reviewContent}>
                        ...
                        {formData.salaryExpectation && <div>
                    ...
                    {formData.additionalInfo && <div className={styles.reviewCard}>
              ...
              <div className={styles.formNavigation}>
                {currentStep > 1 && <button type="button" onClick={prevStep} className={styles.secondaryButton}>
                    Previous
                  </button>}

                {currentStep < 3 ? <button type="button" onClick={nextStep} className={styles.primaryButton}>
                    Next Step
                  </button> : <button type="submit" disabled={submitting} className={styles.submitButton}>
